...
const TODO_ADDED = 'todoAdded', TODO_UPDATED = 'todoUpdated', TODO_DELETED = 'todoRemoved';

@Resolver(of => TodoGqlObject)
export class TodoResolver {
    constructor(private readonly todoService: TodoService, @Inject('PUB_SUB') private pubSub: PubSubEngine) {}
    ...
    async create(@Args('newTodoData') newTodoData: TodoInput){
        ...
        await this.pubSub.publish(TODO_ADDED, {TODO_ADDED: todo});
        return todo;
    }
